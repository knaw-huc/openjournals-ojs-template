...
<div class="ojLayout3col-basic hcMarginTop3">
  {**  col1  *}
  <div class="hcBasicSideMargin hcMarginBottom2">
    {assign var=issueCover value=$issue->getLocalizedCoverImageUrl()}
		{if $issueCover}
    <div class="cardImageWrapper">
      <img class="" src="{$issueCover|escape}" {if $issue->getLocalizedCoverImageAltText() != ''}alt="{$issue->getLocalizedCoverImageAltText()|escape}"{else}alt=""{/if}>
    </div>
    {else}
  ...
  <div class="hcBasicSideMargin">
    <div class="ojBasicWidth">
      ...
      <div class="ojList ojListArticles hcMarginTop1">
        ...
        {**  {$section.articles|@print_r}   *}

        {**$section.article[0]->_data.publications[0]->_data.section_id*}
